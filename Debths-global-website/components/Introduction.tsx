    ...
    <section ref={ref} className="bg-gray-50 py-16 px-6 md:px-12">
      ...
      >
        ...
        <p className="text-lg md:text-xl mb-12">
          We are a team of experts dedicated to providing sustainable business
          solutions, empowering business ownerss with the knowledge and tools to
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-center text-gray-600">
              We are committed to sustainable business practices that promote
          ...
          >
            ...
            <p className="text-center text-gray-600">
              ...
              support to enhance the lives of business ownerss.
            </p>
          </motion.div>
        </div>
      </motion.div>
